---
title: "Simulate confidence interval widths at pre-specified assurance"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{simulate-assurance}
...
Other popular choices for estimands may be marginal means or pairwise contrasts (e.g., derived from the `emmeans` package).
...
This returns an object of the same structure as the original input object (i.e., `precisionSim` or `precisionCurve`). 
